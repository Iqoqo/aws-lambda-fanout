...
const endpoint = process.env.LOCALSTACK_HOSTNAME ? `http://${process.env.LOCALSTACK_HOSTNAME}:4582` : undefined;

var cloudWatch    = new AWS.CloudWatch({
  region: currentRegion,
  endpoint,
  credentials
}); // CloudWatch service for loading the configuration, in the current region
