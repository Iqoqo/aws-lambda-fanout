...
const endpoint = process.env.LOCALSTACK_HOSTNAME ? `http://${process.env.LOCALSTACK_HOSTNAME}:4569` : undefined;
var dynamo        = new AWS.DynamoDB({
  region: currentRegion,
  endpoint,
  credentials
}); // DynamoDB service for loading the configuration, in the current region
